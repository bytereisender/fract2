# Estructura de Archivos del CMS Fract2

## Tabla de Contenidos
1. [Visión General](#visión-general)
2. [Estructura de Desarrollo](#estructura-de-desarrollo)
3. [Estructura de Distribución](#estructura-de-distribución)
4. [Estructura Instalada](#estructura-instalada)
5. [Archivos Clave](#archivos-clave)
6. [Visualización de la Estructura](#visualización-de-la-estructura)

## Visión General

La estructura de archivos del CMS Fract2 está diseñada para proporcionar una clara separación entre desarrollo, distribución e instalación. Esta estructura promueve un desarrollo eficiente y simplifica el proceso de despliegue, mientras que también acomoda la documentación multilingüe.
...
Durante el proceso de distribución, se crea una estructura temporal:
...
Después de completar el proceso, el directorio de distribución solo contiene:
...
Después de ejecutar `fract2-setup.sh`, se crea la siguiente estructura:
...
├── templates/
│   └── index.twig
├── vendor/  # Si se utilizó Composer
├── .git/    # Si se eligió la inicialización de Git
├── LICENSE.md
├── README.md
└── index.php
```
...
- `LICENSE.md`: Licencia BSD 3-Clause del proyecto
- `README.md`: Visión general del proyecto y documentación
- `fract2-dist-packager.sh`: Script para crear el paquete de distribución
- `index.php`: Punto de entrada principal de la aplicación
- `distribution.tar`: Paquete comprimido de todos los archivos de distribución
- `fract2-setup.sh`: Script de instalación para el CMS

## Visualización de la Estructura

Para una representación visual de la estructura de archivos, consulte el archivo `fract2-file-structure.mermaid` en el directorio `docs`.
...
Esta estructura permite una clara separación entre las fases de desarrollo, distribución e instalación del CMS Fract2, facilitando el mantenimiento y el desarrollo continuo del sistema.